...
class TestCountContigAppearances(unittest.TestCase):
    ...
    #    refine_contig_neighbours = RefineContigNeighbours([],'madansi/tests/data/empty_graph.dot','madansi/tests/data/empty_file',gene_detector,  {'Contig1':['','',1000], 'Contig2':['', '', 800], 'Contig3':['','',2000]})
    #    refine_contig_neighbours.genes = {}
    #    self.assertEqual(refine_contig_neighbours.count_contig_appearances([], {}), {})
    #
    ...
    #    gene_detector = GeneDetector('madansi/tests/data/empty_file', 'madansi/tests/data/empty_file' )
    #    refine_contig_neighbours = RefineContigNeighbours('','','madansi/tests/data/empty_file',gene_detector,  {'Contig1':['','',1000], 'Contig2':['', '', 800], 'Contig3':['','',2000]})
    #    refine_contig_neighbours.genes = {}
    #    self.assertEqual(refine_contig_neighbours.count_contig_appearances(['gene1'], {}), {})
    #
    ...
    #    self.assertEqual(refine_contig_neighbours.count_contig_appearances(['gene1'], {}), {'Contig1':[1, ['gene1', None]]})
    #
    ...
    #    refine_contig_neighbours = RefineContigNeighbours('','','madansi/tests/data/empty_file',gene_detector,  {'Contig1':['','',1000], 'Contig2':['', '', 800], 'Contig3':['','',2000]})
    #    refine_contig_neighbours.genes = {'gene1':'Contig1', 'gene2':'Contig1', 'gene3':'Contig2'}
    #    self.assertEqual(refine_contig_neighbours.count_contig_appearances(['gene1', 'gene2', 'gene3'], {}), {'Contig1':[2, ['gene1', 'gene2']], 'Contig2':[1, ['gene3', None]]})
