...
class TestRefineContigNeighbours(unittest.TestCase):
    ...
    def test_keep_all_connections_empty_list(self):
        ...
        refine_contig_neighbours = RefineContigNeighbours(neighbouring_contigs,filtered_graph,'madansi/tests/data/empty_file',gene_detector)
    ...
    def test_keep_two_connections(self):
       ...
       refine_contig_neighbours = RefineContigNeighbours(neighbouring_contigs,filtered_graph,'madansi/tests/data/empty_file', gene_detector)
       refine_contig_neighbours.genes = {   'gene1':'Contig1', 'gene2':'Contig1', 'gene3':'Contig1',\
    ...
    def test_single_gene_from_a_contig(self):
        ...
        refine_contig_neighbours = RefineContigNeighbours(neighbouring_contigs, filtered_graph, 'madansi/tests/data/refine_contig_neighbours_5_blast_hits_file',gene_detector)
        refine_contig_neighbours.genes = {  'gene1':'Contig1', 'gene2':'Contig1', 'gene3':'Contig2',\
    ...
    def test_contig_joins_in_middle(self):
        ...
        refine_contig_neighbours = RefineContigNeighbours(neighbouring_contigs, filtered_graph, 'madansi/tests/data/empty_file',gene_detector)
        refine_contig_neighbours.genes = {  'gene1':'Contig1', 'gene2':'Contig1', 'gene3':'Contig1', 'gene4':'Contig1',\
    ...
    def test_short_contig_in_middle(self):
        ...
        refine_contig_neighbours = RefineContigNeighbours(neighbouring_contigs, filtered_graph, 'madansi/tests/data/refine_contig_neighbours_8_blast_hits_file', gene_detector)
        refine_contig_neighbours.contigs = {'Contig1': {'gene1':None, 'gene2':None, 'gene3':None},\
        ...
        self.assertEqual(sorted(refine_contig_neighbours.refine_contig_neighbours()), sorted([[('Contig1', 'Contig2'),1,['gene3', 'gene4']], [('Contig2', 'Contig3'),1,['gene5', 'gene6']]]))
    ...
    def test_keep_three_cycle_two_equal_weights(self):
        ...
        self.assertEqual(sorted(refine_contig_neighbours.refine_contig_neighbours()), sorted(neighbouring_contigs))
