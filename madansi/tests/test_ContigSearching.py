...
class TestContigSearching(unittest.TestCase):
    ...
    def test_expand_all_contigs_two_contigs_further_separated(self):
        ...
        possible_expected_lists = [\
            sorted([('Contig1', 'Contig2', 1),('Contig1', 'Contig3', 1),('Contig2', 'Contig3', 3)]),\
            sorted([('Contig2', 'Contig1', 1),('Contig1', 'Contig3', 1),('Contig2', 'Contig3', 3)]),\
            sorted([('Contig1', 'Contig2', 1),('Contig3', 'Contig1', 1),('Contig2', 'Contig3', 3)]),\
            sorted([('Contig1', 'Contig2', 1),('Contig1', 'Contig3', 1),('Contig3', 'Contig2', 3)]),\
            sorted([('Contig2', 'Contig1', 1),('Contig3', 'Contig1', 1),('Contig2', 'Contig3', 3)]),\
            sorted([('Contig2', 'Contig1', 1),('Contig1', 'Contig3', 1),('Contig3', 'Contig2', 3)]),\
            sorted([('Contig1', 'Contig2', 1),('Contig3', 'Contig1', 1),('Contig3', 'Contig2', 3)]),\
            sorted([('Contig2', 'Contig1', 1),('Contig3', 'Contig1', 1),('Contig3', 'Contig2', 3)])]
